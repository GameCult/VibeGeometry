...
1. Define the scene brief contract.
...
2. Define the node graph manifest contract.
...
3. Build a minimal Python builder seam.
...
4. Build render review artifacts.
...
5. Add geometry-node idiom notes and examples.
...
6. Generalize after the loop works.
