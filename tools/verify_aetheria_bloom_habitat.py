...
REQUIRED_OBJECTS = {
    "01_open_civic_inner_surface",
    "02_utility_mat_service_interlayer",
    "03_pressure_structural_shell",
    "04_outer_aggregate_shielding",
    "despun_axial_hub",
    "traffic_light_spire_core",
    "GN_Light_Spine_Modifier_Carrier",
    "rotating_spoke_02_transfer_trunk",
    "spoke_base_transfer_collar_02",
    ...
    "central_civic_sea_band",
    "wrapped_road_graph_0",
    "wrapped_river_0",
    "forest_region_0",
    "district_city_region_0",
    "interior_cloud_patch_0",
...
def verify_scene():
    ...
    assert_true(len(mesh_objects) >= 95, f"Expected a populated whole-Bloom study scene, found {len(mesh_objects)} geometry/text objects")
